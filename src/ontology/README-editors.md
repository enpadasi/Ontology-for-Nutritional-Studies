These notes are for the EDITORS of ons
...
Do you have an ID range in the idranges file (ons-idranges.owl),
in this directory). If not, get one from the head curator. 

The editors version is [ons-edit.obo](ons-edit.obo)

** DO NOT EDIT ons.obo OR ons.owl **

ons.obo is the release version
 ...
 * [ons-idranges.owl](ons-idranges.owl)
...
Thus, "ONS:$sequence(8,2000000,2999999)$" will set a range of 8 digit IDs from 200000 
to 2999999.  
...
This generates derived files such as ons.owl and ons.obo and places
 ...
 * https://github.com/obophenotype/ons/releases
 * https://github.com/obophenotype/ons/releases/new
...
what is in the versionIRI of the derived ons.owl (data-version in
ons.obo).
 ...
 * http://purl.obolibrary.org/obo/ons.owl <-- current ontology PURL
 * http://purl.obolibrary.org/obo/ons/releases/YYYY-MM-DD.owl <-- change to the release you just made

For questions on this contact Chris Mungall or email obo-admin AT obofoundry.org

# Travis Continuous Integration System

Check the build status here: [![Build Status](https://travis-ci.org/obophenotype/ons.svg?branch=master)](https://travis-ci.org/ons-ontology/ons)
